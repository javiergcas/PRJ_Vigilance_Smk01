...
echo "auto-generated by afni_proc.py, Tue Nov  3 18:35:25 2020"
echo "(version 7.12, April 14, 2020)"
echo "execution started: `date`"

# to execute via tcsh: 
#   tcsh -xef SC02_Preproc_fMRI.sub-682.sh |& tee output.SC02_Preproc_fMRI.sub-682.sh
# to execute via bash: 
#   tcsh -xef SC02_Preproc_fMRI.sub-682.sh 2>&1 | tee output.SC02_Preproc_fMRI.sub-682.sh
...
set output_dir = /data/SFIM_Vigilance/PRJ_Vigilance_Smk01//PrcsData/sub-682/D02_Preproc_fMRI
...
3dcopy                                                                                          \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk01/PrcsData/sub-682/D01_Anatomical/anatSS.sub-682.nii \
    $output_dir/anatSS.sub-682

# copy anatomical follower datasets into the results dir
3dcopy                                                                                           \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk01/PrcsData/sub-682/D01_Anatomical/anatUAC.sub-682.nii \
    $output_dir/copy_af_anat_w_skull
3dcopy                                                                                           \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk01/Freesurfer/sub-682/SUMA/aparc.a2009s+aseg.nii       \
    $output_dir/copy_af_aaseg
3dcopy                                                                                           \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk01/Freesurfer/sub-682/SUMA/aparc.a2009s+aseg.nii       \
    $output_dir/copy_af_aeseg
3dcopy                                                                                           \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk01/Freesurfer/sub-682/SUMA/fs_ap_latvent.nii.gz        \
    $output_dir/copy_af_FSvent
3dcopy                                                                                           \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk01/Freesurfer/sub-682/SUMA/fs_ap_wm.nii.gz             \
    $output_dir/copy_af_FSWe

# copy external -tlrc_NL_warped_dsets datasets
3dcopy                                                                                               \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk01/PrcsData/sub-682/D01_Anatomical/anatQQ.sub-682.nii      \
    $output_dir/anatQQ.sub-682
3dcopy                                                                                               \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk01/PrcsData/sub-682/D01_Anatomical/anatQQ.sub-682.aff12.1D \
    $output_dir/anatQQ.sub-682.aff12.1D
3dcopy                                                                                               \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk01/PrcsData/sub-682/D01_Anatomical/anatQQ.sub-682_WARP.nii \
    $output_dir/anatQQ.sub-682_WARP.nii

# ============================ auto block: tcat ============================
# apply 3dTcat to copy input dsets to results dir,
# while removing the first 5 TRs
3dTcat -prefix $output_dir/pb00.$subj.r01.tcat                   \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk01/PrcsData/sub-682/D00_OriginalData/sub-682_ses-sleep-task-spatatt+orig'[5..$]'
...
# (new anat will be current anatSS.sub-682+orig)
align_epi_anat.py -anat2epi -anat anatSS.sub-682+orig \
       -suffix _al_junk                               \
...
# warped anat     : anatQQ.sub-682+tlrc
# affine xform    : anatQQ.sub-682.aff12.1D
# non-linear warp : anatQQ.sub-682_WARP.nii

# ================================= volreg =================================
# align each dset to base volume, to anat, warp to tlrc space

# verify that we have a +tlrc warp dataset
if ( ! -f anatQQ.sub-682+tlrc.HEAD ) then
    echo "** missing +tlrc warp dataset: anatQQ.sub-682+tlrc.HEAD" 
    exit
endif
...
foreach run ( $runs )
    ...
    cat_matvec -ONELINE                                                   \
               anatQQ.sub-682.aff12.1D                                    \
               anatSS.sub-682_al_junk_mat.aff12.1D -I                     \
               mat.r$run.vr.aff12.1D > mat.r$run.warp.aff12.1D

    # apply catenated xform: volreg/epi2anat/tlrc/NLtlrc
    # then apply non-linear standard-space warp
    3dNwarpApply -master anatQQ.sub-682+tlrc -dxyz 3                      \
                 -source pb02.$subj.r$run.tshift+orig                     \
                 -nwarp "anatQQ.sub-682_WARP.nii mat.r$run.warp.aff12.1D" \
...
cat_matvec -ONELINE                                                       \
           anatQQ.sub-682.aff12.1D                                        \
           anatSS.sub-682_al_junk_mat.aff12.1D -I  > mat.basewarp.aff12.1D

3dNwarpApply -master anatQQ.sub-682+tlrc -dxyz 3                          \
             -source vr_base+orig                                         \
             -nwarp "anatQQ.sub-682_WARP.nii mat.basewarp.aff12.1D"       \
             -prefix final_epi_vr_base

# create an anat_final dataset, aligned with stats
3dcopy anatQQ.sub-682+tlrc anat_final.$subj
...
3dNwarpApply -source copy_af_anat_w_skull+orig                            \
             ...
             -ainterp wsinc5 -nwarp anatQQ.sub-682_WARP.nii               \
             anatQQ.sub-682.aff12.1D                                      \
             -prefix follow_anat_anat_w_skull
3dNwarpApply -source copy_af_aaseg+orig                                   \
             -master anat_final.$subj+tlrc                                \
             -ainterp NN -nwarp anatQQ.sub-682_WARP.nii                   \
             anatQQ.sub-682.aff12.1D                                      \
...
3dresample -master full_mask.$subj+tlrc -input anatQQ.sub-682+tlrc    \
...
1dBport -nodata 1426 2.0 -band 0.01 0.1 -invert -nozero > bandpass_rall.1D
...
if ( -e @ss_review_basic ) then
    ...
    echo "\nconsider running: \n\n    afni_open -b /data/SFIM_Vigilance/PRJ_Vigilance_Smk01//PrcsData/sub-682/D02_Preproc_fMRI/QC_$subj/index.html\n"
endif
...
#
# afni_proc.py -subj_id sub-682 -blocks despike tshift align tlrc volreg blur                                             \
...
#     /data/SFIM_Vigilance/PRJ_Vigilance_Smk01/PrcsData/sub-682/D00_OriginalData/sub-682_ses-sleep-task-spatatt+orig.HEAD \
...
#     pythonic -out_dir                                                                                                   \
#     /data/SFIM_Vigilance/PRJ_Vigilance_Smk01//PrcsData/sub-682/D02_Preproc_fMRI                                         \
#     -script SC02_Preproc_fMRI.sub-682.sh -volreg_compute_tsnr yes                                                       \
